...
# %%
    ...
    if page == "Predict Customer Cluster":
        ...
        st.write("Enter the values for Recency, Frequency, and Monetary to predict the customer segmentation.")
    ...
    # Input fields for Recency, Frequency, and Monetary
        ...
        if st.button("Predict"):
            ...
            st.write(f"The predicted segmentation for the customer is: {predicted_segment}")
