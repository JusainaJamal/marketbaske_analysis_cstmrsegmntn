...
add_bg_fromm_url("https://img.freepik.com/free-vector/abstract-blue-light-pipe-speed-zoom-black-background-technology_1142-8392.jpg?w=740&t=st=1709980549~exp=1709981149~hmac=0c038a430bbfd569fa492775b4322ef5f9cfca75d26f4f204930e8bfe638cb23")
def app():
    
    # Set page config
    # st.set_page_config(layout="wide")
    page = st.sidebar.radio("Navigation Pane:", ["Welcome Page","Product Recommendation using Market Basket Analysis", "Customer Segmentation based on RFM Analysis", "Dashboard","Predict Customer Cluster"])
    st.sidebar.markdown("")
    st.sidebar.markdown("")
    st.sidebar.markdown("")
    ...
    # Custom CSS styling for the sidebar background color
...
# %%    
    ...
    if page == "Welcome Page":
        css = """
    <style>
        /* Example: Change font style to bold italic */
        .stApp {
...
"""     # Title
        html_temp_title = """
            ...
            <h2 style="color:red; text-align:center;font-size: 60px; font-family: Poppins,Times New Roman,sans-serif">  CUSTOMER SEGMENTATION </h2>
            </div>
        """
        st.markdown(html_temp_title, unsafe_allow_html=True)

# Apply the CSS style using markdown
        ...
        st.markdown("<p style='colore:white; font-size: 24px; font-family: Arial, sans-serif;'>You are logged in! Welcome to our application.</p>", unsafe_allow_html=True)
